...
// ensureUsdWasmRuntime(). Missing companions must fail the package build.
...
for (const file of ['emHdBindings.js', 'emHdBindings.wasm', 'emHdBindings.worker.js', 'emHdBindings.data']) {
