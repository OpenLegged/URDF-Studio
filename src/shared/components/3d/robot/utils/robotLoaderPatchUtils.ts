...
import { URDFJoint as RuntimeURDFJoint } from '@/core/parsers/urdf/loader/index';
...
import { disposeObject3D, disposeMaterial } from '@/shared/utils/three/dispose';
import { disposeReplacedMaterials } from '@/shared/components/3d/materialDisposal';
import { COLLISION_OVERLAY_RENDER_ORDER, collisionBaseMaterial } from '@/core/utils/three/collisionOverlayMaterial';
import { createHighlightOverrideMaterial } from '@/shared/components/3d/materials';
...
import { DEFAULT_RPY, DEFAULT_VEC3 } from '@/core/robot/runtime_patch_diff';
import { syncMjcfTendonVisualMeshMap } from '@/shared/components/3d/robot/utils/mjcfTendonVisualMeshMap';
import type { UrdfJoint, UrdfVisual as LinkGeometry } from '@/types/index';
import { applyURDFMaterialInfoToMaterial, type URDFMaterialInfo } from '@/shared/components/3d/urdfMaterials';
