...
import { GIZMO_BASE_RENDER_ORDER } from '@/shared/components/3d/unified-transform-controls/gizmoCore';
import { MathUtils as SharedMathUtils } from '@/shared/utils/index';
import { type RobotData, type UrdfJoint, type UrdfLink } from '@/types/index';
...
import {
  ...
  createJointAxisViz,
  createOriginAxes,
} from '@/shared/components/3d/robot/utils/visualizationFactories';
...
import {
  ...
  scratchEuler,
  scratchQuaternion,
} from '@/shared/components/3d/robot/utils/visualizationSync/scratch';
import {
  ...
  updateScale,
  updateVisible,
} from '@/shared/components/3d/robot/utils/visualizationSync/objectPrimitives';
import {
  IK_HANDLE_STYLE_VERSION,
  updateBaseRenderOrder,
  updateInteractionColor,
} from '@/shared/components/3d/robot/utils/visualizationSync/interactionPrimitives';
