...
} from '@/shared/components/3d/robot/utils/robotLoadScope';
import { areRobotLinkChangesVisibilityOnly, detectJointPatches, detectGeometryPatches } from '@/core/robot/runtime_patch_diff';
