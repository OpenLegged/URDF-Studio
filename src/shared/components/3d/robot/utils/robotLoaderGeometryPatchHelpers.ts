...
import {
  ...
  URDFCollider,
  URDFVisual,
} from '@/core/parsers/urdf/loader/index';
import {
  createLoadingManager,
  createMeshLoader,
  type ColladaRootNormalizationHints,
} from '@/core/loaders/index';
import {
...
import { GeometryType } from '@/types/index';
import type { UrdfLink, UrdfVisual as LinkGeometry } from '@/types/index';
import { collisionBaseMaterial } from '@/core/utils/three/collisionOverlayMaterial';
import { createHighlightOverrideMaterial, enhanceMaterials } from '@/shared/components/3d/materials';
import { createMatteMaterial } from '@/core/utils/materialFactory';
import { disposeObject3D } from '@/shared/utils/three/dispose';
import { SHARED_MATERIALS } from '@/shared/components/3d/robot/constants';
import { DEFAULT_VEC3, type GeometryPatchCandidate, sameGeometry, sameOrigin, sameVec3, sameVisibleFlag } from '@/core/robot/runtime_patch_diff';
import {
  applyOriginToGroup,
...
} from '@/shared/components/3d/robot/utils/robotLoaderPatchUtils';
import { applyURDFMaterials, applyURDFMaterialTextures, collectURDFMaterialsFromVisualGeometry } from '@/shared/components/3d/urdfMaterials';
