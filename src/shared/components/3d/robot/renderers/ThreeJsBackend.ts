...
import type { RobotData, RobotFile, UrdfJoint, UrdfLink } from '@/types/index';
...
import { syncLoadedRobotScene } from '@/shared/components/3d/robot/renderers/loadedRobotSceneSync';
import { resolveRobotLoaderSourceMetadata } from '@/shared/components/3d/robot/renderers/robotLoaderSourceMetadata';
import {
  resolveViewerRobotSourceFormat,
  type ViewerRobotSourceFormat,
} from '@/shared/components/3d/robot/renderers/sourceFormat';
import { shouldWaitForStructuredUrdfRobotState } from '@/shared/components/3d/robot/renderers/urdfXmlFallbackPolicy';
import type {
  ...
  RendererSceneProps,
  BackendCapabilities,
} from '@/shared/components/3d/robot/renderers/types';
