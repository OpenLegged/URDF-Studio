...
import type { RobotRendererBackend, RendererSceneProps, BackendFactory, BackendRegistry } from '@/shared/components/3d/robot/renderers/types';
import { createThreeJsBackend } from '@/shared/components/3d/robot/renderers/ThreeJsBackend';
import { isUsdLikeFormat } from '@/core/parsers/usd/index';
import type { RobotFile } from '@/types/index';
