import type { RobotModelKernelProps, ViewerDocumentLoadEvent } from '@/shared/components/3d/robot/types';
import { shouldUseIndeterminateStreamingMeshProgress } from '@/shared/components/3d/loadingHudState';
import { ViewerLoadingHudOverlay } from '@/shared/components/3d/robot/components/ViewerLoadingHudOverlay';
import { buildLoadingHudState as buildViewerLoadingHudState } from '@/shared/components/3d/loadingHudState';

interface RobotModelLoadingHudProps {
  visible: boolean;
  loadingProgress: ViewerDocumentLoadEvent | null;
  t: RobotModelKernelProps['t'];
}
