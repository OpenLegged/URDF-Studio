...
import type { InteractionSelection, JointQuaternion, RobotData, UrdfJoint, UrdfLink } from '@/types/index';
import type { RobotModelKernelProps } from '@/shared/components/3d/robot/types';
import { resolveSelectedIkDragLinkId } from '@/shared/components/3d/robot/utils/selectedIkDragLink';
...
interface UseRobotModelIkStateOptions {
  ...
  providedIkRobotState: RobotModelKernelProps['ikRobotState'];
  backendRobotData: RobotData | null;
  onIkCommitKinematicOverrides: RobotModelKernelProps['onIkCommitKinematicOverrides'];
  onJointMotionCommit: RobotModelKernelProps['onJointMotionCommit'];
}
