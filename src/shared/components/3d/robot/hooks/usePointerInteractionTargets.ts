...
import type { ToolMode, ViewerSceneMode } from '@/shared/components/3d/robot/types';
import { collectGizmoRaycastTargets } from '@/shared/components/3d/robot/utils/raycast';
import {
  collectPickTargets,
