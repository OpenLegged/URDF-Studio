...
import { createRendererBackend } from '@/shared/components/3d/robot/renderers/createRendererBackend';
import { type RobotRendererBackend, type RendererSceneProps } from '@/shared/components/3d/robot/renderers/types';
...
import { buildColladaRootNormalizationHints } from '@/core/loaders/index';
...
import type { ViewerDocumentLoadEvent, ViewerRuntimeStageBridge } from '@/shared/components/3d/robot/types';
import {
  createMemoizedRendererBackendLoadScopeKey,
  type RendererBackendLoadScopeKeyMemo,
} from '@/shared/components/3d/robot/utils/rendererBackendLoadScope';
import { detectGeometryPatches, detectJointPatches } from '@/core/robot/runtime_patch_diff';
import { applyGeometryPatchesInPlace } from '@/shared/components/3d/robot/utils/robotLoaderGeometryPatch';
import { patchJointsInPlace } from '@/shared/components/3d/robot/utils/robotLoaderJointPatch';
import {
