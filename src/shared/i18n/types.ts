...
export interface TranslationKeys extends TranslationWorkflowKeys {
  ...
  aiModificationVerifying: string;
  aiModificationVerified: string;
  aiModificationVerificationFailed: string;
  ...
  agentLocalData: string;
  agentLocalDataDescription: string;
  agentStorageMode: string;
  agentStorageIndexedDb: string;
  agentStorageMemory: string;
  agentSessionCount: string;
  agentEventCount: string;
  agentStorageSize: string;
  agentDataExport: string;
  agentDataImport: string;
  agentDataClear: string;
  agentDataClearConfirm: string;
  agentDataClearWarning: string;
  agentDataExported: string;
  agentDataImported: string;
  agentDataCleared: string;
  agentDataOperationFailed: string;
  language: string;
  theme: string;
  about: string;
  more: string;
