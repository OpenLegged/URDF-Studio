...
export const en: TranslationKeys = {
  ...
  aiModificationButton: 'Modify robot',
  aiModificationTitle: 'AI modification',
  aiModificationApply: 'Apply',
  aiModificationDismiss: 'Dismiss',
  aiModificationApplied: 'Applied',
  aiModificationVerifying: 'Checking the updated model…',
  aiModificationVerified: 'Checked the updated result',
  aiModificationVerificationFailed: 'The result needs adjustment; AI is working on it',
  aiModificationNoComponent: 'Select a single robot component to modify it.',
  aiModificationNoChange: 'The AI did not propose any changes.',
  ...
  aiAutoApplyDesc: 'Apply AI-proposed modifications immediately without a confirmation card.',
  ...
  addComponentFailed: 'Could not add component "{name}". See the console for details.',
  robotLoadFailed: 'Could not load {format} file "{name}". Check the file and its dependencies. See the console for details.',
  usdBrowserUnsupported: 'This browser cannot load USD models because Web Worker or OffscreenCanvas support is unavailable. Use a browser that supports both features.',
  ...
  copy: 'Copy',
  copied: 'Copied!',
  copyPosition: 'Copy position XYZ',
  pastePosition: 'Paste position XYZ',
  positionCopied: 'Position XYZ copied',
  positionPasted: 'Position XYZ pasted',
  positionClipboardError: 'Unable to read clipboard content',
  copyAxis: 'Copy rotation/motion axis XYZ',
  pasteAxis: 'Paste rotation/motion axis XYZ',
  axisCopied: 'Rotation/motion axis XYZ copied',
  axisPasted: 'Rotation/motion axis XYZ pasted',
  axisClipboardError: 'Unable to read rotation/motion axis clipboard content',
  ...
  agentLocalData: 'Local session data',
  agentLocalDataDescription:
    'Chats, tool logs, checkpoints, and URDF diffs stay in this browser. Provider credentials are not stored.',
  agentStorageMode: 'Storage',
  agentStorageIndexedDb: 'Browser database',
  agentStorageMemory: 'Temporary memory',
  agentSessionCount: 'Sessions',
  agentEventCount: 'Saved events',
  agentStorageSize: 'Approximate size',
  agentDataExport: 'Export data',
  agentDataImport: 'Import data',
  agentDataClear: 'Clear cache',
  agentDataClearConfirm: 'Clear now',
  agentDataClearWarning:
    'This permanently removes all local Agent sessions, logs, checkpoints, and replay history.',
  agentDataExported: 'Agent data exported.',
  agentDataImported: 'Agent data imported.',
  agentDataCleared: 'Agent local data cleared.',
  agentDataOperationFailed: 'The Agent data operation failed. Check the selected file and try again.',
  language: 'Language',
  theme: 'Theme',
  about: 'About',
  more: 'More',
  ...
  exportFailed: 'Export failed. Try again; details are available in the browser console.',
  exportMjcfClosedLoopJointUnsupported: 'Cannot export MJCF: closed-loop joint {name} uses unsupported {type} semantics. Export SDF or USD to preserve its axis, limits, and degrees of freedom.',
  exportMjcfMissingCollisionGeometry: 'Cannot export MJCF: link {name} is missing collision geometry for mass/inertia estimation. Add collision shapes in the model editor.',
  exportCompatibilityWarning: 'Export completed with compatibility changes. See the browser console for details.',
  exportMjcfPlanarJointWarning: 'MJCF export: planar joint {name} was converted to a free joint.',
  exportMjcfCyclicLinkWarning: 'MJCF export: skipped a cyclic reference to link {name}.',
  exportSdfFloatingJointWarning: 'SDF export: floating joint {name} was omitted; its link will be fixed to its parent.',
  exportAssetPackagingFailed: 'Export failed: could not package asset {file}. Check that the asset is accessible; details are in the browser console.',
  exportMissingMeshAsset: 'Export failed: component {name} is missing mesh asset {file}. Re-import the missing asset.',
  exportWorkspaceBusy: 'Wait for the workspace operation to finish before exporting the project.',
  exportPendingEditFailed: 'Export failed: the pending edit could not be saved. Finish or undo the pending edit and try again.',
