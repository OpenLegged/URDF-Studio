...
export const ViewerToolbar: React.FC<ViewerToolbarProps> = ({
  ...
  const bottomToolbar = bottomDockSlot
    ? createPortal(
        ...
        >
          <div className="urdf-toolbar-track my-1.5 w-max max-w-[calc(100vw-1rem)] overflow-hidden rounded-full border border-border-black/60 bg-panel-bg/75 p-1 shadow-lg backdrop-blur dark:bg-panel-bg/75">
            <div
