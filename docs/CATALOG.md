...
| [viewer.md](viewer.md)                     | Editor/Viewer 子域：拓扑、几何/碰撞/测量、renderer backend、USD runtime     | 131 |
| [file-io.md](file-io.md)                   | 导入导出链路：App 编排、File I/O、Workspace、组装、project archive          | 154 |
