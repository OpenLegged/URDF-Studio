...
| 文档                                                     | 内容                                                                        | 行数 |
| -------------------------------------------------------- | --------------------------------------------------------------------------- | ---- |
| [CLAUDE.md](../CLAUDE.md)                  | 项目入口：定位、结构、红线、Store、命令、导航                               | 206 |
| [viewer.md](viewer.md)                     | Editor/Viewer 子域：拓扑、几何/碰撞/测量、renderer backend、USD runtime     | 150 |
| [file-io.md](file-io.md)                   | 导入导出链路：App 编排、File I/O、Workspace、组装、project archive          | 216 |
| [wasm-build.md](wasm-build.md)             | OpenUSD WASM 构建：源码迁移、编译脚本、故障排查                             | 159 |
| [style-guide.md](style-guide.md)           | UI 样式：语义色 token、蓝色约束、暗色层级、面板文案、验收标准               | 61  |
...
| [update-rules.md](update-rules.md)         | 变更工作流：验收清单、增量命令、测试样本索引、浏览器验证、文档更新映射      | 168 |
